...
int low_h2_r=135, high_h2_r=180;
int low_h_r=0, low_s_r=60, low_v_r=90;
int high_h_r=20, high_s_r=255, high_v_r=255;

int low_h_b=7, low_s_b=120, low_v_b=0;
...
int main(int argc, char **argv)
{
	...
	//hough
    createTrackbar("diff_r","Object Detection_HSV_Red", &diffdistance_r, 180, hough_circle_diff_distance_red);
    createTrackbar("diff_b","Object Detection_HSV_Blue", &diffdistance_b, 180, hough_circle_diff_distance_blue);
    createTrackbar("upT_r","Object Detection_HSV_Red", &upperT_r, 180, hough_circle_upperT_red);
    createTrackbar("upT_b","Object Detection_HSV_Blue", &upperT_b, 180, hough_circle_upperT_blue);
    createTrackbar("cenT_r","Object Detection_HSV_Red", &centerT_r, 180, hough_circle_centerT_red);
    createTrackbar("cenT_b","Object Detection_HSV_Blue", &centerT_b, 180, hough_circle_centerT_blue);
...
void hough_circle_diff_distance_red(int, void *){diffdistance_r=max(diffdistance_r,1);
    setTrackbarPos("diff_r","Object Detection_HSV_Red", diffdistance_r);
}
void hough_circle_diff_distance_blue(int, void *){diffdistance_b=max(diffdistance_b,1);
    setTrackbarPos("diff_b","Object Detection_HSV_Blue", diffdistance_b);
}
void hough_circle_upperT_red(int, void *){upperT_r=max(upperT_r,1);
    setTrackbarPos("upT_r","Object Detection_HSV_Red", upperT_r);
}
void hough_circle_upperT_blue(int, void *){upperT_b=max(upperT_b,1);
    setTrackbarPos("upT_b","Object Detection_HSV_Blue", upperT_b);
}
void hough_circle_centerT_red(int, void *){upperT_r=max(upperT_r,1);
    setTrackbarPos("cenT_r","Object Detection_HSV_Red", centerT_r);
}
void hough_circle_centerT_blue(int, void *){centerT_b=max(centerT_b,1);
    setTrackbarPos("cenT_b","Object Detection_HSV_Blue", centerT_b);
}
